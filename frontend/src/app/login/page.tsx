      ...
      <div className="hidden lg:flex w-1/2 bg-bg-secondary items-center justify-center relative overflow-hidden">
        ...
        >
          <h1 className="text-5xl font-bold text-text-primary leading-tight">
            Your thoughts<br />deserve a<br /><span className="text-accent">safe place.</span>
          </h1>
          ...
          <div className="mt-10 flex gap-6 text-text-muted text-sm">
            <div>
              <p className="text-text-primary text-2xl font-semibold">100%</p>
              <p>Private & Local</p>
            </div>
            <div className="w-px bg-border" />
            <div>
              <p className="text-text-primary text-2xl font-semibold">AI</p>
              <p>Powered Friend</p>
            </div>
            <div className="w-px bg-border" />
            <div>
              <p className="text-text-primary text-2xl font-semibold">Free</p>
              <p>Always</p>
            </div>
          </div>
        </motion.div>
      ...
      <div className="flex-1 flex items-center justify-center px-6">
        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="text-text-secondary mt-1">Sign in to continue to MoodMate</p>
          </div>
